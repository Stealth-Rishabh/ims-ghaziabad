...
include'dbc.php';
$pageTitle="Add a new Patient Service and other attributes";
$pageName="Patient Service Name";
$linkName="All Patient Service";
$tableName="tbl_patient_service";
$listPageUrl="patient-service-list.php";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Patient Service Name *</label> 
        ...
        <div class="col-lg-6">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <?php if($thumb!=""){?>
                        <img src="../media/patientservice/thumb/<?php echo $thumb?>"/>
                    <?php }?>
                    </div>
                    <input class="textbox brand-img1" type="file" name="image1fleimage" > <br>
                    <ul>
                        <li>Recomended image size 360 x 260 px </li>
