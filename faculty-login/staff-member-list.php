...
include'dbc.php';
$pageTitle="List of Staff Member";
$pageName="Staff Member";
$linkName="Add Staff Member";
$tableName="tbl_staff_member";
$addPageUrl="staff-member.php";
$deleteMode="deleteStaff";
$sqlC=mysqli_query($conn,"select * from tbl_staff_title") or die(mysqli_error($conn));
                ...
                ?>
                    <tr>
                        ...
                        if($status==0)
                         ...
                         ?>
                         <td><?php echo $titleNameAry[$staff_id];?></td>
                        <td><?php echo $name;?></td>
                       
                         <td><img height="50" width="50" src="../media/staff/thumb/<?php echo $thumb;?>"></td> 
