...
<head>
    ...
    <title>E-Brochure | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <!--<meta name="robots" content="noindex, nofollow">-->
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/Admission/e-brochure" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/faculty-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">E-Brochure</h1>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="widget-title position-relative mb-4">
                            <h1 class="font-weight-500">E-Brochure</h1>
                              <hr class="hr">
                        </div>
                      <center>
                        <h4>Download E-Brochure </h4> <br>
                        <a href="images/IMSAdmissionBrochureFinalPrintfinal_compressed.pdf" target="_blank" class="btn btn-success"> Download <i class="fas fa-download"></i></a>
                    </center>
                        <!--<iframe src="images/IMSAdmissionBrochureFinalPrintfinal_compressed.pdf"></iframe>-->
                    </div>
                    <?php include 'include/pgdm-sidemenu.php' ?>
                </div>
            </div>
        </section>
