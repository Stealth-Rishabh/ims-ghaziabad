...
include'dbc.php';
$pageTitle="Add a Staff Member and other attributes";
$pageName="Staff Member";
$linkName="All Staff Member";
$tableName="tbl_staff_member";
$listPageUrl="staff-member-list.php";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Select Staff Department *</label> 
                            <select name="txtseldepartment" class="js-source-states form-control" style="width: 100%">
                                <option value="">Select</option>
                                <?php $sql=mysqli_query($conn,"select * from tbl_staff_title order by title asc")or die(mysqli_error($conn));
                                while($row=mysqli_fetch_assoc($sql))
                                {?>
                                <option <?php if($staff_id==$row['id']){ echo 'selected';}?> value="<?php echo $row['id'];?>"><?php echo $row['title']; ?></option>
                            <?php }?>
                            </select>
                        </div> 
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="txtdesignation" value="<?php echo $designation ;?>" required>
                        </div>  
                </div>
            </div>
        </div>
                ...
                <div class="panel-body">
                    <div class="container">
                        ...
                        <div id="brandimageprv1" class="img-content-size-1 common-fram ">
                            <?php if($thumb!=""){?>
                                <img src="../media/staff/thumb/<?php echo $thumb?>"/>
                            <?php }?>
                        </div>
