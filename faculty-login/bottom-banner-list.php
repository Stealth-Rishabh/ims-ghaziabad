...
include'dbc.php';
$pageTitle="List of Bottom Banner Type";
$pageName="Bottom Banner List";
$linkName="Add Bottom Banner";
$tableName="tbl_bannerbottom";
$addPageUrl="bottom-banner.php";
$deleteMode="deleteBottombanner";
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <tr>
                    <th width="20">#</th>
                    <th  width="">Bottom Banner Name</th>
                    <th width="">Image</th>
                ...
                ?>
                    <tr>
                        ...
                        if($status==0)
                         ...
                         ?>
                        <td><?php echo $name;?></td>
                         <td><img height="50" width="50" src="../media/bannerbottom/<?php echo $image;?>"></td> 
