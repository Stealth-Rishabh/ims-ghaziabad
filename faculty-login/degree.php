...
include'dbc.php';
$pageTitle="Add a new Doctor Degree and other attributes";
$pageName="Doctor Degree ";
$linkName="All Doctor Degree ";
$tableName="tbl_degree";
$listPageUrl="degree-list.php";
?>
<!DOCTYPE html>
<html>
<head>
                    ...
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="name" class="form-control" name="txtorder" value="<?php echo $order_number ;?>">
                        </div>     
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <?php if($thumb!=""){?>
                        <img src="../media/degree/thumb/<?php echo $thumb?>"/>
                    <?php }?>
                    </div>
                    <input class="textbox brand-img1" type="file" name="image1fleimage" > <br>
                    <ul>
                        <li>Recomended image size 64 x 64 px </li>
