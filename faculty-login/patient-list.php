...
include'dbc.php';
$pageTitle="List of All Patient Registration";
$pageName="All Patient Registration List";
$linkName="Add Doctor";
$tableName="tbl_patient_registration";
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                ?>
                    <tr>
                        <td><?php echo $i++;?></td>
                        <td><?php echo $name;?><br><small><b> ID : </b><?php echo $patient_id;?></small></td>
                            ...
                            <center>
                             <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="dataQuery/process.php?action3=activePatientaccount&id=<?php echo $row['id'];?>">Unlock</a></li>
                                    <li><a href="dataQuery/process.php?action3=deactivePatientaccount&id=<?php echo $row['id'];?>">Locked</a></li>
                                </ul>
                            </div>
                            </center>
                         </td>  
                        <td> <a class="demo3 btn-danger btn btn-sm" path="dataQuery/process.php?action2=<?php echo $deleteMode ?>&pid=<?php echo $row['id'];?>" ><i class="fa fa-trash"> </i> Delete Account</a></td>
                    </tr>
                    <?php }?> 
                </tbody>
                </table>
