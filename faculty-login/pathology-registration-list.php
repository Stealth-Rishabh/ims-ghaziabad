...
include'dbc.php';
$pageTitle="List of All Pathology Registration";
$pageName="All Pathology Registration List";
$linkName="Add Doctor";
$tableName="tbl_pathology_registration";
$addPageUrl="franchise.php";
$deleteMode="deletePathologyregistration";
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <?php  
                   $i=1;
                   $sql=mysqli_query($conn,"select * from tbl_pathology_registration ORDER BY id desc")or die(mysqli_error());
                ...
                ?>
                    <tr>
                        <td><?php echo $i++;?></td>
                        <td><?php echo $name;?><br><b> ID : </b><?php echo $pathology_id;?></td>
                        ...
                        <td> <a class="demo3 btn-danger btn btn-sm" path="dataQuery/process.php?action2=<?php echo $deleteMode ?>&pathologyid=<?php echo $row['pathology_id'];?>" ><i class="fa fa-trash"> </i> Delete Account</a></td>
                    </tr>
                    <?php }?> 
                </tbody>
                </table>
