...
include'dbc.php';
$pageTitle="List of Promotion Banner Type";
$pageName="Promotion Banner List";
$linkName="Add Promotion Banner";
$tableName="tbl_banneroffer";
$addPageUrl="offer-banner.php";
$deleteMode="deleteBannerOffer";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                ?>
                    <tr>
                        ...
                        if($status==0)
                         ...
                         ?>
                        <td><?php echo $name;?></td>
                         <td><img height="50" width="50" src="../media/banneroffer/<?php echo $image;?>"></td> 
