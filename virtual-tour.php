...
<head>
    ...
    <title>Virtual Tour | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
 
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/virtual-tour" />
...
<body>
    ...
    <?php include 'include/header.php' ?>
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/aboutcumbBnr.jpg)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Take a Virtual Tour</h1>
                </div>
            </div>
        </section>
        ...
        <section class="position-relative placement__section py-4">
            <div class="container">
                <div class="virtual__section">
                    <div class="widget-title position-relative">
                        <h2 class="font-weight-500">Virtual Tour</h2>
                        <hr class="hr">
                    </div>
                    <div class="tour_iframe">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m0!4v1501049357992!6m8!1m7!1syEUDYwSH-FQAAAGu4uaY5g!2m2!1d28.63779669042755!2d77.4596922191613!3f314!4f4.290000000000006!5f0.4000000000000002" width="100%" height="450" frameborder="0" style="border:0"
