...
<head>
    ...
    <title>Director Office | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <link rel="canonical" href="https://www.ims-ghaziabad.ac.in/faculty/director-office" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Director Office</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3" style="max-height:311px;">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690530691.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <h4 class="font-weight-500">Shweta Tyagi</h4>
                                          
                                                <p>EA to Director (Executive Assistant to Director)</p>
                                                
                                                <a href="mailto:director.office@imsgzb.ac.in" style="font-size: 15px;"> <i class="fas fa-envelope"></i> director.office@imsgzb.ac.in</a>
