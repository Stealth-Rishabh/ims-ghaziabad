...
include'dbc.php';
$pageTitle="List of Sub Category";
$pageName="Sub Category List";
$linkName="Add Sub Category";
$tableName="tbl_subcategory";
$addPageUrl="sub-category.php";
$deleteMode="deleteSubCategory";
            ...
            <div class="hpanel">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $name;?></td>
                         <td><img height="50" width="50" src="../media/subcategory/thumb/<?php echo $thumb;?>"></td> 
                         <td>
                            <center>
                             <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="dataQuery/process.php?action3=activeSubcategory&id=<?php echo $id?>">Active</a></li>
                                    <li><a href="dataQuery/process.php?action3=deactiveSubcategory&id=<?php echo $id?>">De-Active</a></li>
                                </ul>
                            </div>
                            </center>
                         </td> 
