...
include'dbc.php';
$pageTitle="Add a new Bottom Banner and other attributes";
$pageName="Bottom Banner";
$linkName="All Bottom Offer";
$tableName="tbl_bannerbottom";
$listPageUrl="bottom-banner-list.php";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Bottom Banner Name *</label> 
                         ...
                         <div class="form-group">
                            ...
                            <input type="name" id="applicationname"  class="form-control" name="txtlink" value="<?php echo $link ;?>">
                        </div>
                         <div class="form-group">
        ...
        <div class="col-lg-6">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <?php if($thumb!=""){?>
                        <img src="../media/banneroffer/thumb/<?php echo $thumb?>"/>
                    <?php }?>
                    </div>
                    <input class="textbox brand-img1" type="file" name="image1fleimage" > <br>
                    <ul>
                        <li>Recomended image size 1400 x 700 px </li>
