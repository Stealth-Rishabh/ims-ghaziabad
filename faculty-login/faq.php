...
include'dbc.php';
$pageTitle="Add a new FAQ and other attributes";
$pageName="FAQ Name";
$linkName="All FAQ";
$tableName="tbl_faq";
$listPageUrl="faq-list.php";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" id="applicationname"  class="form-control" name="txtquestion" value="<?php echo $question ;?>" required>
                        </div> 
                        <div class="form-group">
                            <label for="name">Answer *</label>
                            <textarea  name="txtanswer" placeholder="enter the item description"><?php echo $answer;?></textarea>
                         </div>
                         <div class="form-group">
