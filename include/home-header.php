...
<header id="header" class="header">
                        ...
                        <ul>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a href="https://sites.google.com/imsgzb.ac.in/ims-icon2025/about-the-conference" target="_blank">16 IMS-ICON.2025</a></li>
    ...
    <div class="header_absolute w-100 py-2" style="background-color: #01152c;position: relative;">
        ...
        <div class="wsmainfull clearfix">
            <div class="wsmainwp container clearfix">
                <div class="desktoplogo" style="width: 221px;">
                    <a href="https://www.ims-ghaziabad.ac.in/"><img class="img-fluid" src="public/frontend/images/IMS-logo.webp" style=" width: 57%;margin-top: 5px" alt=""></a>
                </div>
