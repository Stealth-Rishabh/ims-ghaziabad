...
include'dbc.php';
$pageTitle="Edit Franchise and other attributes";
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="txtnumber" value="<?php echo $number ;?>" required>
                        </div>
                        <div class="form-group">
                            <label>Name *</label> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="name" class="form-control" name="txtpassword" value="<?php echo $show_password ;?>" required>
                        </div> 
                         <div class="form-group">
            ...
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <br><br>
                     <div>
                            <button class="btn btn-sm btn-primary m-t-n-xs submitbtn" type="submit"><strong>Update Franchise</strong></button>
                     </div>
                </div>
