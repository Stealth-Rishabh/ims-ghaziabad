...
include'dbc.php';
$pageTitle="List of Faculty Member";
$pageName="Faculty Member";
$linkName="Add Faculty Member";
$tableName="tbl_faculty_member";
$addPageUrl="faculty-member.php";
$deleteMode="deleteFaculty";
$sqlC=mysqli_query($conn,"select * from tbl_faculty_title") or die(mysqli_error($conn));
while($rows=mysqli_fetch_assoc($sqlC)){
    $titleNameAry[$rows['id']]=$rows['title'];
}
?>
<!DOCTYPE html>
<html>
                ...
                ?>
                    <tr>
                        ...
                        if($status==0)
                         ...
                         ?>
                         <td><?php echo $titleNameAry[$faculty_id];?></td>
                        <td><?php echo $name;?></td>
                       
                         <td><img height="50" width="50" src="../media/faculty/thumb/<?php echo $thumb;?>"></td> 
                         <td><?php echo $designation;?></td> 
                         <td><i class="fa fa-envelope"></i> <?php echo $email;?> <br><i class="fa fa-lock"></i> <?php echo $show_password;?></td>
