...
<head>
    ...
    <title>Cafeteria | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />

    <link rel="canonical" href="https://www.ims-ghaziabad.ac.in/lifeims/cafeteria" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/placement-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Cafeteria</h1>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 rankings_accordion">
                        <div class="widget-title position-relative mb-4">
                            <h2 class="font-weight-500">Cafeteria <span class="d-block text-yellow fs-5 mt-1">Good Food is Good Mood </span></h2>
                            <hr class="hr">
                        </div>
                        ...
                        <div class="placement_visible">
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <p>Beside providing quality education to the students, IMS has also provided well furnished Cafeteria in the campus. The cafeteria provides hygienic food to the students in order to keep them physically and mentally healthy
                                        for their studies.</p>
                                                ...
                                                <div class="item_row">
                                                    <div class="popup-gallery-row">
                                                        <div class="single_gallery_item clearfix">
                                                            <img src="public/images/cafeteria/1.webp" alt="">
                                                            <div class="hover_overlay">
                                                                <!-- Popup links -->
                                                                <div class="links">
                                                                    <a href="public/images/cafeteria/1.webp" data-fancybox="gallery" data-caption="Cafeteria">
                                        ...
                                        <div class="lecture_room-item">
                                            <div class="gallery_area">
                                                <div class="item_row">
                                                    <div class="popup-gallery-row">
                                                        <div class="single_gallery_item clearfix">
                                                            <img src="public/images/cafeteria/2.webp" alt="">
                                                            <div class="hover_overlay">
                                                                <!-- Popup links -->
                                                                <div class="links">
                                                                    <a href="public/images/cafeteria/2.webp" data-fancybox="gallery" data-caption="Cafeteria">
                                                                        <i class="fa-regular fa-eye"></i>
                                                                    </a>
                                                                </div>
                                        ...
                                        <div class="lecture_room-item">
                                            <div class="gallery_area">
                                                <div class="item_row">
                                                    <div class="popup-gallery-row">
                                                        <div class="single_gallery_item clearfix">
                                                            <img src="public/images/cafeteria/3.webp" alt="">
                                                            <div class="hover_overlay">
                                                                <!-- Popup links -->
                                                                <div class="links">
                                                                    <a href="public/images/cafeteria/3.webp" data-fancybox="gallery" data-caption="Cafeteria">
                                                                        <i class="fa-regular fa-eye"></i>
                                                                    </a>
                                                                </div>
                                        ...
                                        <div class="lecture_room-item">
                                            <div class="gallery_area">
                                                <div class="item_row">
                                                    <div class="popup-gallery-row">
                                                        <div class="single_gallery_item clearfix">
                                                            <img src="public/images/cafeteria/4.webp" alt="">
                                                            <div class="hover_overlay">
                                                                <!-- Popup links -->
                                                                <div class="links">
                                                                    <a href="public/images/cafeteria/4.webp" data-fancybox="gallery" data-caption="Cafeteria">
                                                                        <i class="fa-regular fa-eye"></i>
                                                                    </a>
                                                                </div>
                                        ...
                                        <div class="lecture_room-item">
                                            <div class="gallery_area">
                                                <div class="item_row">
                                                    <div class="popup-gallery-row">
                                                        <div class="single_gallery_item clearfix">
                                                            <img src="public/images/cafeteria/5.webp" alt="">
                                                            <div class="hover_overlay">
                                                                <!-- Popup links -->
                                                                <div class="links">
                                                                    <a href="public/images/cafeteria/5.webp" data-fancybox="gallery" data-caption="Cafeteria">
                                                                        <i class="fa-regular fa-eye"></i>
                                                                    </a>
                                                                </div>
                                        ...
                                        <div class="lecture_room-item">
                                            <div class="gallery_area">
                                                <div class="item_row">
                                                    <div class="popup-gallery-row">
                                                        <div class="single_gallery_item clearfix">
                                                            <img src="public/images/cafeteria/6.webp" alt="">
                                                            <div class="hover_overlay">
                                                                <!-- Popup links -->
                                                                <div class="links">
                                                                    <a href="public/images/cafeteria/6.webp" data-fancybox="gallery" data-caption="Cafeteria">
                                                                        <i class="fa-regular fa-eye"></i>
                                                                    </a>
                                                                </div>
