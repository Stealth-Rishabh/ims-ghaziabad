...
<head>
    ...
    <title>Admission Department Staff | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/faculty/admission-department-pgdm" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Admission Department Staff</h1>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        ...
                        <div class="faculty-box text-center">
                            <!--<h2 class="text-start text-white mb-4">Marketing</h2>-->
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/ashish-Kr-panda"><img class="img-fluid" src="public/images/1690531103.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/ashish-Kr-panda"><h4 class="font-weight-500">Ashish Kr. Panda</h4></a>
                                            <a href="faculty/details/ashish-Kr-panda">
                                                <p>Head Admissions</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690531350.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Kamini Shishodia</h4></a>
                                            <a href="#">
                                                <p>Manager</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690531390.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Neha Sharma</h4></a>
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690531486.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Kusum Rani</h4></a>
                                            <a href="#">
                                                <p>Manager</p>
                                            </a>
                                ...
                                <!--    <div class="faculty_item position-relative py-5 px-3">-->
                                <!--        <div class="faculty-img bdr-ripple">-->
                                <!--            <a href="#"><img class="img-fluid" src="public/images/1690531523.webp" alt="" /></a>-->
                                <!--        </div>-->

                                <!--        <div class="faculty-content mt-4">-->
                                <!--            <a href="#"><h4 class="font-weight-500">Gunjan Bindal</h4></a>-->
                                <!--            <a href="#">-->
                                <!--                <p>Deputy Manager</p>-->
                                <!--            </a>-->
                                ...
                                <!--    <div class="faculty_item position-relative py-5 px-3">-->
                                <!--        <div class="faculty-img bdr-ripple">-->
                                <!--            <a href="#"><img class="img-fluid" src="public/images/1690531590.webp" alt="" /></a>-->
                                <!--        </div>-->

                                <!--        <div class="faculty-content mt-4">-->
                                <!--            <a href="#"><h4 class="font-weight-500">Ritu Chauhan</h4></a>-->
                                <!--            <a href="#">-->
                                <!--                <p>Admission Counselor</p>-->
                                <!--            </a>-->
                                ...
                                <!--</div>-->
                                 ...
                                 <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690531631.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Nidhi Bhardwaj</h4></a>
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="images/Manila_Garg_pic.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Manila Garg</h4></a>
                                            <a href="#">
                                                <p>Assistant Manager</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1710492698.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Diksha Verma</h4></a>
                                            <a href="#">
                                                <p>Sr. Counselor (Admissions)</p>
                                            </a>
                                 ...
                                 <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/santosh.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Santosh Kumar Singh</h4></a>
                                            <a href="#">
                                                <p>Manager</p>
                                            </a>
                        ...
                        <div class="widget-title position-relative my-4">
                    ...
                    <?php include 'include/administration-sidemenu.php' ?>
                </div>
            </div>
        </section>
