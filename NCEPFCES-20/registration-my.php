...
$mesasge.='<p>Looking forward to your kind participation</p>';   

$to = "shakhertyagi1@gmail.com , shakhertyagiimb@gmail.com";
              ...
              <fieldset class="answer">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="paper_code" id="paper_code" class="form-control"  value="<?php echo $paper_code;?>" palceholder="For eg. MKTCG01" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                              ...
                              <input type="text" name="coauthors1" id="coauthors1" class="form-control"  value="<?php echo $coauthors1;?>" onKeyPress="return isAlphabetWithDot(event)">
                        ...
                        <div class="form-group">
                          ...
                          <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                              ...
                              <input type="text" name="coauthors2" id="paper_code" class="form-control"  value="<?php echo $coauthors2;?>" onKeyPress="return isAlphabetWithDot(event)">
