...
include'dbc.php';
$pageTitle="List of All Vendor";
$pageName="All Vendor List";
$linkName="Add Vendor";
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                {extract($row);
                  $sql2=mysqli_query($conn,"select * from tbl_listing_view_contact where vendorid='$vendorid' and status='1'")or die(mysqli_error());
                    ...
                    <tr>
                        ...
                        <td><?php echo $categoryNameAry[$category_id];?> / <?php echo $subcategoryNameAry[$sub_category_id];?></td>
                         ...
                         <td>
                          ...
                          <td><a href="user-list-contact-view.php?vendorid=<?php echo $vendorid; ?>" class="btn-sm btn-success" style="background-color: darkgoldenrod !important;"><span style="font-weight: 800;">( <?php echo $rowcount; ?> )</span> View Users</a></td>
                         <td><a href="vendor-view.php?vendorid=<?php echo $vendorid; ?>" class="btn-sm btn-primary">View Listing</a></td>
