...
<head>
    ...
    <title>HR Faculty | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <meta name="robots" content="noindex, nofollow">
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/faculty/hr" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">HR Faculty</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/parul-yadav"><img class="img-fluid" src="public/images/ParulYadav.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/parul-yadav"><h4 class="font-weight-500">Dr. Parul Yadav</h4></a>
                                            <a href="faculty/details/parul-yadav">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/rina-pandey"><img class="img-fluid" src="public/images/Rina.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/rina-pandey"><h4 class="font-weight-500">Dr. Rina Pandey</h4></a>
                                            <a href="faculty/details/rina-pandey">
                                                <p>Professor</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/parul-agarwal"><img class="img-fluid" src="public/images/1690528280.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/parul-agarwal"><h4 class="font-weight-500">Dr. Parul Agarwal</h4></a>
                                            <a href="faculty/details/parul-agarwal">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/shikha-agnihotri"><img class="img-fluid" src="public/images/Shikha.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/shikha-agnihotri"><h4 class="font-weight-500">Dr. Shikha Agnihotri</h4></a>
                                            <a href="faculty/details/shikha-agnihotri">
