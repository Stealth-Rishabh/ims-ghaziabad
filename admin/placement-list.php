...
include'dbc.php';
$pageTitle="List of Placement Stories";
$pageName="News Placement Stories";
$linkName="Add Placement Stories";
$tableName="tbl_placement_success";
$addPageUrl="placement.php";
$deleteMode="deletePlacement";
$sqlC=mysqli_query($conn,"select * from tbl_placement_year") or die(mysqli_error($conn));
while($rows=mysqli_fetch_assoc($sqlC)){
    $yearNameAry[$rows['id']]=$rows['year'];
}
?>
<!DOCTYPE html>
<html>
                ...
                ?>
                    <tr>
                        ...
                        if($status==0)
                         ...
                         ?>
                        <td><?php echo $name;?></td>
                        <td><?php echo $yearNameAry[$year_id];?></td>
                         <td><img height="50" width="50" src="../media/placement/thumb/<?php echo $student_thumb;?>"></td> 
                         <td><img height="50" width="50" src="../media/placement/thumb/<?php echo $logo_thumb;?>"></td> 
