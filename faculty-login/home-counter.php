...
include'dbc.php';
$pageTitle="Add a new Home Counter and other attributes";
$pageName="Home Counter";
$linkName="All Counter";
$tableName="tbl_home_counter";
$listPageUrl="home-counter-list.php";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Name *</label> 
                            <input type="text" id="applicationname"  class="form-control" name="txtname" value="<?php echo $name ;?>" required>
                        </div>
                        <div class="form-group">
                            <label>Counter *</label> 
                            <input type="text" id="applicationname"  class="form-control" name="txtcounter" value="<?php echo $counter ;?>" required>
                        </div>
                         <div class="form-group">
