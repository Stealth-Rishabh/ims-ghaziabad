...
include'dbc.php';
$pageTitle="List of All Hospital & Clinic Registration";
$pageName="All Hospital & Clinic Registration List";
$linkName="Add Doctor";
$tableName="tbl_hospital_registration";
$addPageUrl="franchise.php";
$deleteMode="deleteHospitalregistration";
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                {extract($row);
                $sqlname=mysqli_query($conn,"select * from tbl_hospital_detail where    hospitalid='$hospital_id'")or die(mysqli_error());
                    $rowhname=mysqli_fetch_assoc($sqlname);

                ?>
                    <tr>
                        <td><?php echo $i++;?></td>
                        <td><b><?php echo $rowhname['name']; ?></b><br><?php echo $name;?><br><b> ID : </b><?php echo $hospital_id;?></td>
                        <td><?php echo $mobile;?> </td>
                        <td><?php echo $show_password;?></td>
                        <td><?php echo $otp;?></td>
                        <td><?php echo $cityNameAry[$city_id];?><br><?php echo $datee;?></td>
                        <td>
                            <center>
                             <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="dataQuery/process.php?action3=activeAccount&id=<?php echo $row['id'];?>">Unlock</a></li>
                                    <li><a href="dataQuery/process.php?action3=deactiveAccount&id=<?php echo $row['id'];?>">Locked</a></li>
                                </ul>
                            </div>
                            </center>
                         </td>  
                        <td> <a class="demo3 btn-danger btn btn-sm" path="dataQuery/process.php?action2=<?php echo $deleteMode ?>&hosid=<?php echo $row['hospital_id'];?>" ><i class="fa fa-trash"> </i> Delete Account</a></td>
                    </tr>
                    <?php }?> 
                </tbody>
                </table>
