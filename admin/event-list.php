...
include'dbc.php';
$pageTitle="List of Event";
$pageName="Event List";
$linkName="Add Event";
$tableName="tbl_event";
$addPageUrl="event.php";
$deleteMode="deleteEvent";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $title;?></td>
                         <td><img height="50" width="50" src="../media/event/thumb/<?php echo $thumb;?>"></td> 
                          <td><?php echo $start_date;?> <br><?php echo $end_date;?></td>
