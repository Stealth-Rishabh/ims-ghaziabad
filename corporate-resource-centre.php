...
<head>
    ...
    <title>Corporate Resource Centre | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/placements/corporate-resource-centre" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/placement-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Corporate Resource Centre</h1>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="widget-title position-relative mb-4">
                            <h1 class="font-weight-500">Corporate Resource Centre</h1>
                            <hr class="hr">
                        ...
                        <div class="placement_visible">
                            <div class="row">
                                <div class="col-lg-12">
                                    <p>The corporate resource center or the Placement Cell plays a vital role in bringing the industry and academia close to each other by providing Career Counseling, need based education and organization support. It has
                                        the task to organize campus interviews for student placement and training and also organizes corporate guest lectures and industry interaction.</p>


                                    <p class="mt-4">CRC acts as an interface between the students, faculty and the corporate world to initiate continuous interaction with the industry , sharing industry experiences, and understanding the needs of the corporate world.
                                        CRC has been regularly inviting heads of leading Companies to the campus, who share their insights into the latest issues concerning the economy to stimulate and enhance the intellectual climate at IMS</p>
                                ...
                                <div class="col-lg-12">
                                    <div class="image-box rounded_thumb mt-4 rounded-0">
                                        <figure class="image zindex2">
                                            <a href="#"><img class="img-fluid shadow" src="public/images/seleThumb.webp" alt=""></a>
                                        </figure>
                                    </div>
                                ...
                                <div class="tittle_bg mt-4">
                                    <h3 class="text-white fs-4">For more details Contact</h3>
                                ...
                                <div class="col-lg-6">
                                    <h5 class="mt-4 mb-3 fs-5">Mr. Asjad Iqbal (Head - CRC)</h5>
                                    ...
                                    <div class="ulc">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="text">
                                                    <p>Mob : +91-9811366652
                                                        <br>Ph : 0120-4170600(30 Lines),
                                                        <br> Fax : 0120-2866034</p>
                                            ...
                                            <li>
                                                <div class="icon"><span class="fa-solid fa-map"></span></div>


                                                <div class="text">
                                                    <p>Institute of Management Studies Lal Quan, Bulandshahar Road Ghaziabad-201 009, National Capital Region, INDIA</p>
                    ...
                    <?php include 'include/placement-sidemenu.php' ?>
                </div>
            </div>
        </section>
