...
include'dbc.php';
$pageTitle="List of All Doctor Booking";
$pageName="All Doctor Booking List";
$linkName="Add Doctor Booking";
$tableName="tbl_doctor_booking";
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                ?>
                     <tr>
                                               <td><?php echo $i++; ?></td>
                                                <td style="color: red;font-weight: 500;"><?php echo $doctorname; ?></td>
                                                  <td><?php echo $patientname; ?></td>
                                                  <td><?php echo $bookingdate; ?><br><?php echo $seltime; ?></td>
                                                  <td><?php echo $age; ?><br><?php echo $gender; ?></td>
                                                  <td><?php echo $city; ?></td>
                                                  <td><?php echo $amount; ?>-<b style="color:darkgreen"><?php echo $payment_id; ?></b></td>
                                                    <td style="color: green;font-weight: 500;">New Appointment</td>
                                               </tr>
                    <?php }?> 
                </tbody>
                </table>
