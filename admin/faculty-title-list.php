...
include'dbc.php';
$pageTitle="Add a new Faculty Titie and other attributes";
$pageName="Faculty Title";
$linkName="";
$tableName="tbl_faculty_title";
$listPageUrl="";
$addPageUrl="faculty-title-list.php";
$deleteMode="deleteFacultyTitle";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="applicationname"  class="form-control" name="txttitle" value="<?php echo $title;?>" required>
                        </div>
                        <div class="form-group">
                            <label>Url *</label> 
