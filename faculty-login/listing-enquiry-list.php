...
include'dbc.php';
$pageTitle="List of All Lisitng Enquiry";
$pageName="All Listing Enquiry List";
$linkName="Add Vendor";
$tableName="tbl_listing_enquiry";
$addPageUrl="vendor.php";
$deleteMode="deleteLisitngenquiry";
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                ?>
                    <tr>
                        <td><?php echo $i++;?></td>
                        <td><?php echo $vendorname;?> / <?php echo $subcategoryNameAry[$vendorsubcateid];?><br></td>
                        <td><?php echo $name;?></td>
                        <td><?php echo $enquirydate;?></td>
                         <td><a href="lisitng-view-enquiry.php?id=<?php echo $id; ?>" class="btn-sm btn-primary">View </a></td>
                         <td><a class="demo3 btn-danger btn-sm" path="dataQuery/process.php?action2=<?php echo $deleteMode ?>&id=<?php echo $id?>" ><i class="fa fa-trash"> </i> Remove</a></td>
                    </tr>
                    <?php }?> 
                </tbody>
                </table>
