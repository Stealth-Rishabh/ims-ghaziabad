...
include'dbc.php';
$pageTitle="Add a Faculty Member and other attributes";
$pageName="Faculty Member";
$linkName="All Faculty Member";
$tableName="tbl_faculty_member";
$listPageUrl="faculty-member-list.php";
?>
<!DOCTYPE html>
<html>
<head>
...
<?php
 ...
 $sqlf=mysqli_query($conn,"select * from tbl_faculty_member where email='$email'") or die(mysqli_error($conn));
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select name="txtseldepartment" class="js-source-states form-control" style="width: 100%">
                                <option value="">Select</option>
                                <?php $sql=mysqli_query($conn,"select * from tbl_faculty_title order by title asc")or die(mysqli_error($conn));
                                while($row=mysqli_fetch_assoc($sql))
                                {?>
                                <option <?php if($faculty_id==$row['id']){ echo 'selected';}?> value="<?php echo $row['id'];?>"><?php echo $row['title']; ?></option>
                            <?php }?>
                            </select>
                        </div> 
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  class="form-control" name="txtdesignation" value="<?php echo $designation ;?>">
                        </div>  
                        <div class="form-group">
                            ...
                            <?php
                                if (isset($_GET['m66'])) {
                                    echo "<p style='color: red;font-weight: 600;'>Email ID already exists.</p>";
                                }
                              ?>
                        </div>
                         <div class="form-group">
