...
include'dbc.php';
$pageTitle="Add a new Shoes Heel Height and other attributes";
$pageName="Shoes Heel Height";
$linkName="";
$tableName="tbl_heel_height";
$listPageUrl="";
$addPageUrl="shoes-heel-height.php";
$deleteMode="deleteheelHeight";
?>
<!DOCTYPE html>
<html>
<head>
