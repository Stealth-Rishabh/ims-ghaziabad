...
include'dbc.php';
$pageTitle="Add a new Staff Titie and other attributes";
$pageName="Staff Title";
$linkName="";
$tableName="tbl_staff_title";
$listPageUrl="";
$addPageUrl="staff-title-list.php";
$deleteMode="deleteStaffTitle";
?>
<!DOCTYPE html>
<html>
<head>
