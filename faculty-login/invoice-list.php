...
$linkName="Add Invoice";
$tableName="tbl_invoice";
$addPageUrl="invoice.php";
$deleteMode="deleteInvoice";
$sqlC=mysqli_query($conn,"select * from tbl_vendor") or die(mysqli_error($conn));
while($rows=mysqli_fetch_assoc($sqlC)){
    $vendorNameAry[$rows['id']]=$rows['vendor_name'];
    $vendorbusinessnameAry[$rows['id']]=$rows['businessname'];
}
?>
<!DOCTYPE html>
<html>
                ...
                ?>
                    <tr>
                        ...
                        if($status==0)
                         ...
                         ?>
                        <td><?php echo $vendorNameAry[$vendor_id];?></td>
                          <td><?php echo $vendorbusinessnameAry[$vendor_id];?></td>
                          <td><?php echo $plan;?></td>
