...
include'dbc.php';
$pageTitle="List of Doctor Degree";
$pageName="Doctor Degree List";
$linkName="Add Doctor Degree";
$tableName="tbl_degree";
$addPageUrl="degree.php";
$deleteMode="deleteDegree";
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="hpanel">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $name;?></td>
                         <td><img height="50" width="50" src="../media/degree/thumb/<?php echo $thumb;?>"></td> 
