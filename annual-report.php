...
<head>
    ...
    <title>Annual Report | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
 
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/annual-report" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/aboutcumbBnr.jpg)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Annual Report </h1>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="widget-title position-relative mb-4">
                            <h1 class="font-weight-500">Annual Report</h1>
                            <hr class="hr">
                        </div>


                        <div class="nirf__section">
                            <div class="row g-3  text-center">
                                
                                <div class="col-lg-4 col-md-6 col-6">
                                    <div class="position-relative nirf-item shadow">
                                        <a target="_blank" href="public/images/pdf/BalanceSheet2023-24.pdf">
                                            <div class="nirf_pdf"><i class="fa-regular fa-file-pdf"></i></div>
                                            <div class="nirf_head">2023-2024</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-6">
                                    <div class="position-relative nirf-item shadow">
                                        <a target="_blank" href="public/images/pdf/BalanceSheet2022-23.pdf">
                                            <div class="nirf_pdf"><i class="fa-regular fa-file-pdf"></i></div>
                                            <div class="nirf_head">2022-2023</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-6">
                                    <div class="position-relative nirf-item shadow">
                                        <a target="_blank" href="public/images/pdf/BalanceSheet2021-22.pdf">
                                            <div class="nirf_pdf"><i class="fa-regular fa-file-pdf"></i></div>
                                            <div class="nirf_head">2021-2022</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-6">
                                    <div class="position-relative nirf-item shadow">
                                        <a target="_blank" href="public/images/pdf/bs-2020-21.pdf">
                                            <div class="nirf_pdf"><i class="fa-regular fa-file-pdf"></i></div>
                                            <div class="nirf_head">2020-2021</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-6">
                                    <div class="position-relative nirf-item shadow">
                                        <a target="_blank" href="public/images/pdf/bs-2019-20.pdf">
                                            <div class="nirf_pdf"><i class="fa-regular fa-file-pdf"></i></div>
                                            <div class="nirf_head">2019-2020</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-6">
                                    <div class="position-relative nirf-item shadow">
                                        <a target="_blank" href="public/images/pdf/bs-2018-19.pdf">
                                            <div class="nirf_pdf"><i class="fa-regular fa-file-pdf"></i></div>
                                            <div class="nirf_head">2018-2019</div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-6">
                                    <div class="position-relative nirf-item shadow">
                                        <a target="_blank" href="public/images/pdf/bs-2017-18.pdf">
                                            <div class="nirf_pdf"><i class="fa-regular fa-file-pdf"></i></div>
                                            <div class="nirf_head">2017-2018</div>
                                        </a>
                                    </div>
                                </div>
