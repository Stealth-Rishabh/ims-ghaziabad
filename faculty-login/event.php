...
include'dbc.php';
$pageTitle="Add a new Event and other attributes";
$pageName="Event";
$linkName="All Event";
$tableName="tbl_event";
$listPageUrl="event-list.php";
?>
<!DOCTYPE html>
<html>
<head>
                ...
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Title *</label> 
                            <input type="name" id="applicationname"  class="form-control" name="txttitle" value="<?php echo $title ;?>" required>
                        </div>
                        <div class="form-group">
                            <label>Url *</label> 
                        ...
                        <div class="form-group">
                            ...
                            <input type="date"  class="form-control" name="txtstartdate" value="<?php echo $start_date ;?>" required>
                        </div>
                        <div class="form-group">
                            <label>End Date </label> 
                            <input type="date"   class="form-control" name="txtenddate" value="<?php echo $end_date ;?>">
                        </div>
                        <div class="form-group">
                            <label>Meta Title * </label> 
                            <input type="text"  class="form-control" name="txtmetatitle" value="<?php echo $meta_title ;?>" required>
                        </div>
                        <div class="form-group">
                            <label>Meta Keywords * </label> 
                            <input type="text"  class="form-control" name="txtmetakeywords" value="<?php echo $meta_keyword ;?>" required>
                        </div>
                        <div class="form-group">
                            <label>Meta Description * </label> 
                            <input type="text"  class="form-control" name="txtmetadescription" value="<?php echo $meta_description ;?>" required>
                        </div>
                        <div class="form-group">
        ...
        <div class="col-lg-6">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <?php if($thumb!=""){?>
                        <img src="../media/event/thumb/<?php echo $thumb?>"/>
                    <?php }?>
                    </div>
                    <input class="textbox brand-img1" type="file" name="image1fleimage" > <br>
                    <ul>
                        <li>Recomended image size 1920 x 730 px </li>
