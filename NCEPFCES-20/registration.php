...
if($submit)
 ...
 $rs = mysql_query($sql);
  ...
  $mesasge =' <table width="648" style="border:1px solid rgba(207,207,207,1.00);">';
  $mesasge.='   <tr> <td  colspan="2"><img src="https://www.ims-ghaziabad.ac.in/bootstrap/front/images/logo.png" alt="ims logo"><hr></td> </tr>';
  $mesasge.='  <tr><td colspan="2" style="font-weight:bold; text-align:center;"><p style="color:rgba(0,0,0,0.5); font-size:22px;">ACKNOWLEDGEMENT &amp; RECEIPT*</p>';

 

  $mesasge.='<p>INTERNATIONAL CONFERENCE ON CORPORATE GOVERNANCE</p> <p>RETROSPECTS &amp; PROSPECTS (ICCG IMSGZB 2017)<br> FEB-12-13, 2017</p><hr></td> </tr>'; 

  $mesasge.='   <tr>  <td width="267"><strong>Name :</strong></td>  <td width="393"><strong>'.$name.'</strong></td>  </tr>';

  $mesasge.='   <tr><td><strong>Affiliation :</strong></td> <td><strong>'.$affiliation.'</strong></td></tr>';

  $mesasge.='  <tr> <td><strong>Category : </strong></td> <td><strong>'.$category.'</strong></td> </tr>';

  $mesasge.='  <tr><td><strong>Paper Title : </strong></td><td><strong>'.$title_paper.'</strong></td> </tr>';

  $mesasge.='  <tr> <td><strong>Amount Paid **:</strong></td> <td><strong>'.$amt_paid.'</strong></td></tr>';

  $mesasge.='  <tr> <td><strong>Mode : </strong></td><td><strong>'.$mode_payment.'</strong></td></tr>';

  $mesasge.='  <tr> <td><strong>Bank:  </strong></td> <td><strong>'.$bank_name.'</strong></td> </tr>';

  $mesasge.='  <tr> <td><strong>DD No. / Transaction No. : </strong></td><td><strong>'.$payment_ref_no.'</strong></td></tr>';

  $mesasge.='  <tr> <td><strong>Date of Payment: </strong></td> <td><strong>'.$payment_date.'</strong></td> </tr>';

  $mesasge.='  <tr> <td colspan="2"><hr><strong>This is a system generated reciept & does not require any signatures</strong></td> </tr>';

  $mesasge.='   <tr> <td colspan="2"><strong>* Provisional </strong></td> </tr>';

  $mesasge.='  <tr> <td colspan="2"><strong>** Subject to realization </strong></td> </tr>';

  $mesasge.='  <tr> <td colspan="2" align="center"><img src="https://www.ims-ghaziabad.ac.in/IntConf2017/images/ims-ghaziabad-footer.jpg" alt="IMS Ghaziabad"></td> </tr></table>';
...
$to = "conf2017@imsgzb.com , sk.dube@imsgzb.com, pankaj.kumar@imsgzb.com";

//$to = "shakhertyagi1@gmail.com , bedivicky@gmail.com";
...
<title>National Conference - Emerging Perspectives of Finance and Changing Economic Scenario</title>
<!-- Bootstrap CSS -->
...
<div id="main">
  ...
  <!-- end header -->
  <div class="banner"> <img src="images/NCEPFCES-19-banner.jpg">
    <div class="clr"></div>
  </div>
  <!-- start navigation -->
  ...
  <div class="main-content">
    <div class="row">
      <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
        <h2>Registration</h2>
        <p>An early bird discount of 20% will be given to authors of accepted papers/participants, in case registration is done by January 01, 2017.</p>
            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
              <div class="form-group">
                ...
                <select name="category" class="form-control"  required>
                  ...
                  <option value="Corporate_Delegates_ims">Corporate Delegates (IMS Alumni) -  INR 2500</option>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  ...
                  <h3 style="text-align:left;">Are You Paper Presenter? &nbsp;&nbsp;
                    <input id="coupon_question" type="radio" name="presenter" value="Paper Presenter" />
                    <span class="item-text">Yes</span></h3>
                  </fieldset>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  <h3 style="text-align:left;">Are You Observer/Delegate? &nbsp;&nbsp;
                    <input id="coupon_question1" type="radio" name="presenter" value="Observer/Delegate"  />
                    <span>Yes</span></h3>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group">
                    <p>Do you have any Co-authors &nbsp;&nbsp;
                      <input id="coupon_question12" type="checkbox" name="do_coauthors" value="Yes" />
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <p>Separate Certificate Required &nbsp;&nbsp;
                              <input id="coupon_question13" type="checkbox" name="certi_require1" value="Yes" />
                            </p>
                          </div>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <p>Separate Certificate Required &nbsp;&nbsp;
                              <input id="coupon_question14" type="checkbox" name="certi_require2" value="Yes" />
                            </p>
                          </div>
                        </div>
                      </div>
  ...
  <!-- start footer -->
  <footer> Copyright &copy; 2017, IMS Ghaziabad, All rights reserved | <a href="#">Privacy Policy</a>
    <div class="clr"></div>
  </footer>
  <!-- end footer -->
  <div class="clr"></div>
...
<div class="answer2">
  ...
  <a href="javascript:void(0);" id="hide" class="btn btn-success btn-md">I Agree.</a> </div>
<div class="answer3">
  <p>The number of co-authors for a paper is capped at <span>Three</span>. If the paper is in Joint names and one of the coauthors attends and makes a presentation, one certificate will be issued in the joint names. </p>
  <p>If more than one coauthors attend or require Separate certificate, fee registration will be required to be done for each co-author.The amount in that case would be <span>doubled</span> in case of Two Separate Certificates and <span>Tripled</span> for Three Separate Certificates.</p>
  <a href="javascript:void(0);" id="hide1" class="btn btn-success btn-md">I Agree.</a> </div>
