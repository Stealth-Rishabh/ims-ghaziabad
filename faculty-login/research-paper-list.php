...
include'dbc.php';
$pageTitle="List of Research Paper";
$pageName="Research Paper List";
$linkName="Add Research Paper";
$tableName="tbl_research_paper";
$addPageUrl="research-paper.php";
$deleteMode="deleteResearchPaper";
 ...
 $sqlf=mysqli_query($conn,"select * from tbl_faculty_member where email='$email'") or die(mysqli_error($conn));
    ...
    $facultyid=$rowf['id'];
$sqlC=mysqli_query($conn,"select * from tbl_faculty_member") or die(mysqli_error($conn));
while($rows=mysqli_fetch_assoc($sqlC)){
    $facultyNameAry[$rows['id']]=$rows['name'];
}
?>
<!DOCTYPE html>
<html>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <tr>
                    <th width="20">#</th>
                    <th  width="40">Name of Faculty</th>
                    <th  width="40">Research Paper Name</th>
                    <th  width="50">Year</th>
                    <th  width="50">Link</th>
                ...
                <?php  
                   $i=1;
                   $sql=mysqli_query($conn,"select * from $tableName where faculty_id='$facultyid' ORDER BY id desc")or die(mysqli_error());
                ...
                ?>
                    <tr>
                        ...
                        if($status==0)
                         ...
                         ?>
                        <td><?php echo $facultyNameAry[$faculty_id];?></td>
                        <td><?php echo $name_paper;?></td>
                        <td><?php echo $year;?></td>
                        <td><center><a class="btn btn-sm btn-primary" href="<?php echo $link;?>" target="_blank">Link <i class="fa fa-link" aria-hidden="true"></i></a></center></td>
