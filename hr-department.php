...
<head>
    ...
    <title>HR Department Staff | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/faculty/hr-department" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">HR Department Staff</h1>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <!--            <a href="#"><img class="img-fluid" src="public/images/1690781312.webp" alt="" /></a>-->
                                <!--        </div>-->

                                <!--        <div class="faculty-content mt-4">-->
                                <!--            <a href="#"><h4 class="font-weight-500">Gaurav Jain</h4></a>-->
                                <!--            <a href="#">-->
                                <!--                <p>Manager - HR</p>-->
                                <!--            </a>-->
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690781426.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Dev Dutt Kumar</h4></a>
                                            <a href="#">
                                                <p>Executive - HR</p>
                                            </a>
