    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <?php  
                   $i=1;
                   $sql=mysqli_query($conn,"select * from tbl_hospital_detail where type='Clinic' ORDER BY id desc")or die(mysqli_error());
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $name;?><br><b>CL ID : </b><?php echo $hospitalid;?></td>
                        <td><?php echo $profiledate;?></td>
                        <td><?php echo $rowpic['address'];?><br><b>City :</b><?php echo $cityNameAry[$cityid];?></td>
                        <td><a href="clinic-doctor-list.php?clinicid=<?php echo $hospitaliddd; ?>" class="btn-sm btn-primary"><?php echo $doctorcount; ?> Doctor <i class="fa fa-arrow-right"></i> </a></td>
                         <td>
                            <center>
                             <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="dataQuery/process.php?action3=activeClinic&id=<?php echo $rowpic['id'];?>">Active</a></li>
                                    <li><a href="dataQuery/process.php?action3=deactiveClinic&id=<?php echo $rowpic['id'];?>">De-Active</a></li>
                                </ul>
                            </div>
                            </center>
                         </td> 
                         <td><a class="demo3 btn-danger btn btn-sm" path="dataQuery/process.php?action2=<?php echo $deleteMode ?>&clinicid=<?php echo $rowpic['hospitalid'];?>" ><i class="fa fa-trash"> </i> Delete Clinic</a></td>
