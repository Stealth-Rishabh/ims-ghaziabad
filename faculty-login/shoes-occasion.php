...
include'dbc.php';
$pageTitle="Add a new Shoes Occasion and other attributes";
$pageName="Shoes Occasion";
$linkName="";
$tableName="tbl_shoes_occasion";
$listPageUrl="";
$addPageUrl="shoes-occasion.php";
$deleteMode="deleteshoesOccasion";
?>
<!DOCTYPE html>
<html>
<head>
    ...
    else
    {
        ...
        $thumb    ="";
         ...
         $commissionpercentage="";
            $mode="addshoesOccasion";
            $idd="";
            $btnname="Save Shoes Occasion";
            $active='';
    }
