...
<head>
    ...
    <title>Accounts Department Staff | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <!--<meta name="robots" content="noindex, nofollow">-->
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/faculty/accounts-department" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Accounts Department Staff</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1697181627.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Neeru</h4></a>
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1697182006.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Pradeep Kumar</h4></a>
                                            <a href="#">
                                                <p>Accountant</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1697182112.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">R.K. Verma</h4></a>
                                            <a href="#">
                                                <p>Clerk</p>
                                            </a>
