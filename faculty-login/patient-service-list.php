...
include'dbc.php';
$pageTitle="List of Patient Service";
$pageName="Patient Service List";
$linkName="Add Patient Service";
$tableName="tbl_patient_service";
$addPageUrl="patient-service.php";
$deleteMode="deletePatientService";
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <tr>
                    ...
                    <th  width="50">Patient Service</th>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $name;?></td>
                         <td><img height="50" width="50" src="../media/patientservice/thumb/<?php echo $thumb;?>"></td> 
                         <td>
                            <center>
                             <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="dataQuery/process.php?action3=activePatientService&id=<?php echo $id?>">Active</a></li>
                                    <li><a href="dataQuery/process.php?action3=deactivePatientService&id=<?php echo $id?>">De-Active</a></li>
                                </ul>
                            </div>
                            </center>
                         </td> 
