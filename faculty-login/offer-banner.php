...
include'dbc.php';
$pageTitle="Add a new Promotion Banner and other attributes";
$pageName="Promotion Banner";
$linkName="All Promotion Banner";
$tableName="tbl_banneroffer";
$listPageUrl="offer-banner-list.php";
?>
<!DOCTYPE html>
<html>
<head>
