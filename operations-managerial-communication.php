...
<head>
    ...
    <title>Operations & Managerial Communication Faculty | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <meta name="robots" content="noindex, nofollow">
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/faculty/operations-managerial-communication" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">Operations & Managerial Communication Faculty</h1>
                </div>
            </div>
        </section>
        ...
        <section class="position-relative placement__section py-4">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        <div class="widget-title position-relative mb-4">
                            ...
                            <h2 class="font-weight-500">
                                    Operations &amp; Managerial Communication
                        </h2>
                            <hr class="hr">
                        </div>
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/naveen-virmani"><img class="img-fluid" src="public/images/1690529433.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/naveen-virmani"><h4 class="font-weight-500">Dr. Naveen Virmani</h4></a>
                                            <a href="faculty/details/naveen-virmani">
                                                <p>Associate Professor &amp; Area Chair</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/Vikram"><img class="img-fluid" src="public/images/Vikram.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/Vikram"><h4 class="font-weight-500">Mr. Vikram Kumar Sharma</h4></a>
                                            <a href="faculty/details/Vikram">
                        ...
                        <div class="widget-title position-relative my-4">
                            ...
                            <h2 class="font-weight-500"> Managerial Communication</h2>
                            <hr class="hr">
                        ...
                        <div class="faculty-box text-center">
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6 ">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/anindita"> <img class="img-fluid" src="public/images/andita.png" alt=""> </a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/anindita"><h4 class="font-weight-500">Dr. Anindita</h4> </a>
                                            <a href="faculty/details/anindita">
                                                <p>Professor</p>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6 ">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/aditi-jain"> <img class="img-fluid" src="public/images/1698751228.png" alt=""> </a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/aditi-jain"><h4 class="font-weight-500">Ms. Aditi Jain</h4> </a>
                                            <a href="faculty/details/aditi-jain">
                                                <p>Assistant Professor</p>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6 ">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/anchal-mishra"> <img class="img-fluid" src="public/images/1711525141.png" alt=""> </a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/anchal-mishra"><h4 class="font-weight-500">Anchal Mishra</h4> </a>
                                            <a href="faculty/details/anchal-mishra">
                                                <p>Professor- Communication Skills</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php include 'include/faculty-sidemenu.php' ?>
                </div>
            </div>
        </section>
