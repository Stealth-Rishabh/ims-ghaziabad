...
include'dbc.php';
$pageTitle="Add a new Sub Category and other attributes";
$pageName="Sub Category Name";
$linkName="All Sub Category";
$tableName="tbl_subcategory";
$listPageUrl="sub-category-list.php";
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-lg-6">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <?php if($thumb!=""){?>
                        <img src="../media/subcategory/thumb/<?php echo $thumb?>"/>
                    <?php }?>
                    </div>
