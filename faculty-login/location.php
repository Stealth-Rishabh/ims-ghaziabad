...
include'dbc.php';
$pageTitle="Add a new Location and other attributes";
$pageName="Location";
$linkName="";
$tableName="tbl_location";
$listPageUrl="";
$addPageUrl="location.php";
$deleteMode="deleteLocation";
$getcityid=$_GET['cityid'];
$sql22=mysqli_query($conn,"select * from tbl_city where id='$getcityid'")or die(mysqli_error());
...
<div class="content">
    ...
    padding: 2px;"><?php echo $row22['name']; ?></span> Location
                </div>
                <div class="panel-body">
                    <form role="form" id="form" action="dataQuery/process.php" method="post" enctype="multipart/form-data">
                         ...
                         <input type="hidden"  name="txtcityid" value="<?php echo $getcityid;?>"   />
                        <div class="form-group">
                            <label>Location Name *</label> 
                            <input type="text" class="form-control" name="txtlocationname" value="<?php echo $location;?>" required>
                        </div>
                         <div>
        ...
        <div class="col-lg-6">
            <div class="hpanel">
                <div class="panel-heading">
                     <?php echo $row22['name']; ?> Location List *
                </div>
                <div class="panel-body">
                ...
                <?php  
                   $i=1;
                   $sql3=mysqli_query($conn,"select * from tbl_location where cityid='$getcityid' ORDER BY id desc")or die(mysqli_error());
                            ...
                            <div class="btn-group">
                               <button data-toggle="dropdown" class="btn btn-danger dropdown-toggle btn-sm">Action <span class="caret"></span></button>
                                    <ul class="dropdown-menu animated flipInX m-t-xs" role="menu" style="top:0;">
                                        <li><a href="<?php echo $addPageUrl ?>?id=<?php echo $row3['id']?>&cityid=<?php echo $getcityid;?>"><i class="fa fa-pencil"> </i> Edit</a></li>
                                        <li><a class="demo3" path="dataQuery/process.php?action2=<?php echo $deleteMode ?>&id=<?php echo $row3['id']?>&cityid=<?php echo $getcityid;?>" ><i class="fa fa-trash"> </i> Remove</a></li>
                                        <li class="divider"></li>
