...
include'dbc.php';
$pageTitle="Add a new Home Logo and other attributes";
$pageName="Home Logo";
$linkName="All Logo";
$tableName="tbl_home_logo";
$listPageUrl="home-logo-list.php";
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-lg-6">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <?php if($thumb!=""){?>
                        <img src="../media/logo/thumb/<?php echo $thumb?>"/>
                    <?php }?>
                    </div>
                    <input class="textbox brand-img1" type="file" name="image1fleimage" > <br>
                    <ul>
                        <li>Recomended image size 1800 x 1800 px </li>
