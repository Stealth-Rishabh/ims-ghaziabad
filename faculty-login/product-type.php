...
include'dbc.php';
$pageTitle="Add a new Product Type and other attributes";
$pageName="Product Type";
$linkName="All Product Type";
$tableName="tbl_producttype";
$listPageUrl="product-type-list.php";
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="col-lg-6">
            <div class="hpanel">
                ...
                <div class="panel-body">
                    ...
                    <?php if($image!=""){?>
                        <img src="../media/producttype/<?php echo $image?>"/>
                    <?php }?>
                    </div>
                    <input class="textbox brand-img1" type="file" name="image1fleimage" > <br>
                    <ul>
                        <li>Recomended image size 400 x 400 px </li>
