...
$pageTitle="List of Live Product ";
$pageName="Live Vendor Product List";
$linkName="Add Vendor";
...
<div id="wrapper">
    ...
    <div class="small-header">
        <div class="hpanel">
            <div class="panel-body" style="background-color:darkgreen;color: white;">
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                <?php  
                   ...
                   $kl=1;
                   $ty=1;
                   $sql=mysqli_query($conn,"select * from tbl_product where vendorid='$getvendorid' and adminstatus='1' and status='1' ORDER BY id desc")or die(mysqli_error());
                while($row=mysqli_fetch_assoc($sql))
                {
                   extract($row);
                ...
                ?>
                    <tr>
                      ...
                      <td><?php echo $i++;?></td>
                                ...
                                <div class="modal-body">
                                  <form>
                                        ...
                                        <div class="mb-3">
                                         ...
                                         <div class="mb-3">
                                            <label class="col-form-label">Exchange Available within Days:</label>
                                            <input type="text" class="form-control" readonly value="<?php echo $exchangeday; ?>">
                                        </div><br>
                                         <div class="mb-3">
                                            <label class="col-form-label">Country of Orign:</label>
                        ...
                        <!-- model close -->
                        <td><a href="dataQuery/process.php?action3=deactiveProduct&id=<?php echo $id?>&vendorid=<?php echo $getvendorid?>" class="btn-sm btn-danger">GO DEACTIVE</a></td>
                    </tr>
                    <?php }?> 
                </tbody>
                </table>
