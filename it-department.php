...
<head>
    ...
    <title>IT Department Staff | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/faculty/it-department" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">IT Department Staff</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690781502.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Anugrah Pratap Singh</h4></a>
                                            <a href="#">
                                                <p>IT- Manager</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690781544.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Mukesh Giri</h4></a>
                                            <a href="#">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690781658.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Vijendra Singh</h4></a>
                                            <a href="#">
                                                <p>System Executive</p>
                                            </a>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="#"><img class="img-fluid" src="public/images/1690781711.webp" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="#"><h4 class="font-weight-500">Deepak Thakur</h4></a>
                                            <a href="#">
                                                <p>Lab Assistant</p>
                                            </a>
