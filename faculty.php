...
$geturl=$_GET['url'];
 $sqlfaq=mysqli_query($conn,"select * from tbl_faculty_title where url='$geturl'")or die(mysqli_error());
    $rowfaq=mysqli_fetch_assoc($sqlfaq);
    $faculty_title_id=$rowfaq['id'];
?>
<head>
    ...
    <title><?php echo $rowfaq['title']; ?> Faculty | IMS Ghaziabad</title>
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative"><?php echo $rowfaq['title']; ?> Faculty</h1>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12">
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <?php  
                             $sql=mysqli_query($conn,"select * from tbl_faculty_member where faculty_id='$faculty_title_id' and status='1' ORDER BY ordernumber asc")or die(mysqli_error());
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/<?php echo $url; ?>"><img class="img-fluid" src="media/faculty/<?php echo $image;?>" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/<?php echo $url; ?>"><h4 class="font-weight-500"><?php echo $name; ?></h4></a>
                                            <a href="faculty/details/<?php echo $url; ?>">
