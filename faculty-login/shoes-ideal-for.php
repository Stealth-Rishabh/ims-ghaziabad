...
include'dbc.php';
$pageTitle="Add a new Shoes Ideal For and other attributes";
$pageName="Shoes Ideal For";
$linkName="";
$tableName="tbl_ideal_for";
$listPageUrl="";
$addPageUrl="shoes-ideal-for.php";
$deleteMode="deleteidealFor";
?>
<!DOCTYPE html>
<html>
<head>
