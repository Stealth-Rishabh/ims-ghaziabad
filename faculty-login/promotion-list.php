...
include'dbc.php';
$pageTitle="List of Promotion Banner";
$pageName="Promotion Banner List";
$linkName="Add Promotion Banner";
$tableName="tbl_promotion";
$addPageUrl="promotion-banner.php";
$deleteMode="deletePromotionBanner";
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="hpanel">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $name;?></td>
                         <td><img height="50" width="50" src="../media/promotion/thumb/<?php echo $thumb;?>"></td> 
                         <td>
                            <center>
                             <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="dataQuery/process.php?action3=activeCategory&id=<?php echo $id?>">Active</a></li>
                                    <li><a href="dataQuery/process.php?action3=deactiveCategory&id=<?php echo $id?>">De-Active</a></li>
                                </ul>
                            </div>
                            </center>
                         </td> 
