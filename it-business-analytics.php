...
<head>
    ...
    <title>IT (Business Analytics) Faculty | IMS Ghaziabad</title>
    <meta name="keywords" content="" />
    <meta name="description" content="" />
    <meta name="robots" content="noindex, nofollow">
    <link rel="canonical" href="https://ims-ghaziabad.ac.in/faculty/it-business-analytics" />
        ...
        <section class="position-relative breadcumb-wrapper" style="background-image: url(public/images/staff-banner.png)">
            <div class="container">
                <div class="breadcumb-content position-relative zindex2 text-center wow fadeInUp">
                    <h1 class="breadcumb-title text-white font-weight-700 position-relative">IT (Business Analytics) Faculty</h1>
                </div>
            </div>
        </section>
                        ...
                        <div class="faculty-box text-center">
                            ...
                            <div class="row g-3 d-flex justify-content-center flex-wrap">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/abhishek-bhushan-singhal"><img class="img-fluid" src="public/images/Abhishek.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/abhishek-bhushan-singhal"><h4 class="font-weight-500">Dr. Abhishek Bhushan Singhal</h4></a>
                                            <a href="faculty/details/abhishek-bhushan-singhal">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/ahimsa-bhardwaj"><img class="img-fluid" src="public/images/1698746059.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/ahimsa-bhardwaj"><h4 class="font-weight-500">Ms Ahimsa Bhardwaj</h4></a>
                                            <a href="faculty/details/ahimsa-bhardwaj">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="faculty_item position-relative py-5 px-3">
                                        <div class="faculty-img bdr-ripple">
                                            <a href="faculty/details/anirban-kanjilal"><img class="img-fluid" src="public/images/1711529723.png" alt="" /></a>
                                        </div>

                                        <div class="faculty-content mt-4">
                                            <a href="faculty/details/anirban-kanjilal"><h4 class="font-weight-500">Anirban Kanjilal</h4></a>
                                            <a href="faculty/details/anirban-kanjilal">
                                                <p>Assistant Professor Data Analytics</p>
                                            </a>
