...
include'dbc.php';
$pageTitle="List of All Doctor Registration";
$pageName="All Doctor Registration List";
$linkName="Add Doctor";
$tableName="tbl_doctor_registration";
$addPageUrl="franchise.php";
$deleteMode="deleteDoctorregistration";
        ...
        <div class="col-lg-12">
            <div class="hpanel">
                ...
                ?>
                    <tr>
                        <td><?php echo $i++;?></td>
                        <td><?php echo $name;?><br><b>DOC ID : </b><?php echo $doctor_id;?></td>
                        <td><?php echo $mobile;?> </td>
                        <td><?php echo $show_password;?></td>
                        <td><?php echo $otp;?></td>
                        <td><?php echo $cityNameAry[$city_id];?></td>
                        <td><?php echo $datee;?></td>  
                        <td> <a class="demo3 btn-danger btn btn-sm" path="dataQuery/process.php?action2=<?php echo $deleteMode ?>&docid=<?php echo $row['doctor_id'];?>" ><i class="fa fa-trash"> </i> Delete Account</a></td>
                    </tr>
                    <?php }?> 
                </tbody>
                </table>
