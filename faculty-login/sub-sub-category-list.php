...
include'dbc.php';
$pageTitle="List of Child Category";
$pageName="Child Category List";
$linkName="Add Child Category";
$tableName="tbl_sub_subcategory";
$addPageUrl="sub-sub-category.php";
$deleteMode="deleteSubSubCategory";
...
$sqlD=mysqli_query($conn,"select * from tbl_subcategory ") or die(mysqli_error($conn));
while($row2=mysqli_fetch_assoc($sqlD)){
    $subcategoryNameAry[$row2['id']]=$row2['name'];
} 
$sqlPT=mysqli_query($conn,"select * from tbl_producttype") or die(mysqli_error($conn));
while($row3=mysqli_fetch_assoc($sqlPT)){
    $producttypeNameAry[$row3['id']]=$row3['name'];
} 
?>
<!DOCTYPE html>
<html>
            ...
            <div class="hpanel">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $categoryNameAry[$category_id];?></td>
                        <td><?php echo $subcategoryNameAry[$sub_category_id];?></td>
                        <td><?php echo $name;?></td>
                         <td><img height="50" width="50" src="../media/subsubcategory/thumb/<?php echo $thumb;?>"></td> 
                         <td><center><button class="btn btn-primary btn-sm" type="button"> <?php echo $producttypeNameAry[$product_type_id];?> </button></center></td>
                         <td>
                            <center>
                             <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="dataQuery/process.php?action3=activeSubsubcategory&id=<?php echo $id?>">Active</a></li>
                                    <li><a href="dataQuery/process.php?action3=deactiveSubsubcategory&id=<?php echo $id?>">De-Active</a></li>
                                </ul>
                            </div>
                            </center>
                         </td> 
