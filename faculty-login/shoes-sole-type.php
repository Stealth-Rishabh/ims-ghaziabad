...
include'dbc.php';
$pageTitle="Add a new Sole Type and other attributes";
$pageName="Sole Type";
$linkName="";
$tableName="tbl_sole_type";
$listPageUrl="";
$addPageUrl="shoes-sole-type.php";
$deleteMode="deletesoleType";
?>
<!DOCTYPE html>
<html>
<head>
